              ...
              {tabs.map((tab, index) => (
                <button
                  ...
                  className={`
                    ...
                    ${
                      activeTab === tab.key
                        ? "bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 border-b-2 border-indigo-500 dark:border-indigo-600"
                        : "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50 border-b-2 border-transparent"
                    }
                  `}
                >
                  {/* Active tab indicator */}
                  {activeTab === tab.key && (
                    <div className="absolute inset-x-0 bottom-0 h-0.5 bg-indigo-500 dark:bg-indigo-600"></div>
                  )}
